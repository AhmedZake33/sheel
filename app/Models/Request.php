...
class Request extends Model
{
    ...
    public function data($type = System::DATA_BRIEF)
    {
        ...
        $data->estimatedCost = number_format($locationProvider->calcDistance($this->current_lat , $this->current_lng , $this->destination_lat , $this->destination_lng)*env('costPerKilo') , 3);
